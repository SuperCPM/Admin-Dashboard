    ...
    return (
        ...
        >
            <div className="flex gap-x-3 p-3">
                <p className="text-lg font-medium text-slate-900 transition-colors dark:text-slate-50">IGB</p>
            </div>
                    ...
                    >
                        ...
                        {navbarLink.links.map((link) => (
                            <NavLink
                                ...
                                className={({ isActive }) => cn("sidebar-item", collapsed && "md:w-[45px]", isActive && "active")}
                            >
                                <link.icon
                                    size={22}
